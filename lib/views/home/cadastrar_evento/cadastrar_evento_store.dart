...
part 'cadastrar_evento_store.g.dart';

class CadastrarEventoStore = CadastrarEventoStoreBase with _$CadastrarEventoStore;

abstract class CadastrarEventoStoreBase with Store {
  // observables
  @observable
