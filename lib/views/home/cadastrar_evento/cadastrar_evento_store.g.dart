...
part of 'cadastrar_evento_store.dart';
...
mixin _$CadastrarEventoStore on CadastrarEventoStoreBase, Store {
  late final _$_cidadesAtom =
      Atom(name: 'CadastrarEventoStoreBase._cidades', context: context);
  ...
  late final _$_bairrosAtom =
      Atom(name: 'CadastrarEventoStoreBase._bairros', context: context);
  ...
  late final _$_cidadeSelecionadaAtom = Atom(
      name: 'CadastrarEventoStoreBase._cidadeSelecionada', context: context);
  ...
  late final _$_bairroSelecionadoAtom = Atom(
      name: 'CadastrarEventoStoreBase._bairroSelecionado', context: context);
  ...
  late final _$CadastrarEventoStoreBaseActionController =
      ActionController(name: 'CadastrarEventoStoreBase', context: context);

  @override
  void setCidades(List<Cidade> cidades) {
    final _$actionInfo = _$CadastrarEventoStoreBaseActionController.startAction(
        name: 'CadastrarEventoStoreBase.setCidades');
    try {
      return super.setCidades(cidades);
    } finally {
      _$CadastrarEventoStoreBaseActionController.endAction(_$actionInfo);
    }
  }
  ...
  void setBairros(List<Bairro> bairros) {
    final _$actionInfo = _$CadastrarEventoStoreBaseActionController.startAction(
        name: 'CadastrarEventoStoreBase.setBairros');
    try {
  ...
  void updateCidadeSelecionada(Cidade? cidade) {
    final _$actionInfo = _$CadastrarEventoStoreBaseActionController.startAction(
        name: 'CadastrarEventoStoreBase.updateCidadeSelecionada');
    try {
